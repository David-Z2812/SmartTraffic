...
public class Dispositivo implements IDispositivo {
	...
	protected FuncionPublisher_APIMQTT apiPublisherMQTT = null;
	protected Dispositivo_APIREST apiFuncionesREST = null;
	public static boolean habilitada = true;
	...
	public static Dispositivo build(String deviceId, String ip, String mqttBrokerURL) {
		...
		dispositivo.apiPublisherMQTT = FuncionPublisher_APIMQTT.build(dispositivo, mqttBrokerURL);
	...
	public void processInfoMessage(String payload) {
		...
		// Subclasses like PanelInformativo should override this
	}
